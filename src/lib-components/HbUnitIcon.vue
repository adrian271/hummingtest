...
<template>
  <span>
    <span v-if="!strokeCheck">
      <svg
        v-if="unit_type == 'residential'"
        :width="unitWidth"
        :height="unitHeight"
        :style="{ marginBottom: marginBottom, verticalAlign: verticalAlign }"
        viewBox="2 0 24 24"
    ...
    <span v-if="strokeCheck">
      ...
      <svg
        v-else-if="unit_type == 'residential'"
        :width="unitWidth"
        :height="unitHeight"
        viewBox="0 0 48 48"
        fill="none"
...
export default {
  ...
  created() {
    this.unit_type = this.unit && (this.unit.type || this.unit.unit_type);
  },
  computed: {
