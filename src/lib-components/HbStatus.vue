        ...
        data: function() {
            return {
                types: [
                    ...
                    { color: '#FFD600', name: 'To Overlock', description: 'To Overlock'},
                    ...
                    { color: '#02AD0F', name: 'Converted Lead', description: 'Tenant that is digitally or manually converted'},
                    { color: '#02AD0F', name: 'Converted', description: 'Tenant that is digitally or manually converted'},
